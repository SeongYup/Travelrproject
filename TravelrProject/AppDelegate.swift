...
>>>>>>> origin/master
            ...
            let jpy_ = jpyJsonDictionary["rates"] as! [String:Double]
            let jpy = jpy_["KRW"]!
            
            let eur_ = eurJsonDictionary["rates"] as! [String:Double]
            let eur = eur_["KRW"]!
            
            let gbp_ = gbpJsonDictionary["rates"] as! [String:Double]
            let gbp = gbp_["KRW"]!
            
            let cny_ = cnyJsonDictionary["rates"] as! [String:Double]
            let cny = cny_["KRW"]!

            
            
            print(usd,jpy,eur,gbp,cny) //확인
